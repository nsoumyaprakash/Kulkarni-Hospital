...
<div id="page-preloader">
    <div class="preload-container">
        <div class="preload-cube">
            <div class="preload-half1">
                <div class="preload-side preload-s1"></div>
                <div class="preload-side preload-s2"></div>
                <div class="preload-side preload-s5"></div>
            </div>
            <div class="preload-half2">
                <div class="preload-side preload-s3"></div>
                <div class="preload-side preload-s4"></div>
                <div class="preload-side preload-s6"></div>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="col-lg-9 d-lg-block d-md-none d-sm-none d-none ">
                        ...
                        <nav class="navbar navbar-expand-lg justify-content-left">
                            <ul class="navbar-nav">
                                ...
                                <li class="active dropdown"><a href="#" class="nav-link">Pages</a>
                                    <ul class="dropdown-menu">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li><a href="#">I want To</a>
                                <ul>
                                    ...
                                    <li><a href="#"><i class="icofont icofont-ui-calendar"></i> Request an
                                            Appointment</a></li>
                                    <li><a href="#"><i class="icofont icofont-medical-sign"></i> Book a Healthcheck</a>
                                    </li>
                                    <li><a href="#"><i class="icofont icofont-prescription"></i> Access Lab Reports </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <form>
                            <div class="row">
                                <div class="form-group col-lg-10 col-md-10 col-12 p-0">
                                    <input class="form-control" name="searcher" placeholder="Search again here..."
                                        type="text">
                                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-lg-0 mb-md-4 mb-4">
                <div class="sidebar-widget">
                    ...
                    <div class="servide-list">
                        <ul>
                            <li><a href="#"><i class="icofont icofont-rounded-right"></i> Digital Bariatric Surgery</a>
                            </li>
                            <li><a href="#"><i class="icofont icofont-rounded-right"></i> Obesity: A Growing
                                    Epidemic</a> </li>
                            <li><a href="#"><i class="icofont icofont-rounded-right"></i> After Surgery Bed Rest</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="sidebar-widget">
                    ...
                    <div class="servide-list">
                        <ul>
                            ...
                            <li><a href="#"><i class="icofont icofont-rounded-right"></i> Accident & Emergency (5)</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="sidebar-widget">
                    ...
                    <div class="servide-list">
                        <ul>
                            ...
                            <li><a href="#"><i class="icofont icofont-rounded-right"></i> About Sensiv</a> </li>
        ...
        <div class="row">
            <div class="client-slider owl-carousel owl-theme">
                <div class="single-client">
                    <a href="#"><img class="img-fluid" src="../img/clients/1.png" alt=""></a>
                </div>
                <!-- end single client -->
                <div class="single-client">
                    <a href="#"><img class="img-fluid" src="../img/clients/2.png" alt=""></a>
                </div>
                <!-- end single client -->
                <div class="single-client">
                    <a href="#"><img class="img-fluid" src="../img/clients/3.png" alt=""></a>
                </div>
                <!-- end single client -->
                <div class="single-client">
                    <a href="#"><img class="img-fluid" src="../img/clients/4.png" alt=""></a>
                </div>
                <!-- end single client -->
                <div class="single-client">
                    <a href="#"><img class="img-fluid" src="../img/clients/1.png" alt=""></a>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 col-12  mb-lg-0 mb-md-4 mb-sm-5 mb-5 footer-widget">
                    ...
                    <div class="footer-logo">
                        <a href="#">
                            <img class="img-fluid" src="../img/app-google.png" alt="">
                        </a>
                        <a href="#">
                            <img class="img-fluid" src="../img/app-apple.png" alt="">
                        </a>
                    </div>
                </div>
                <!-- End Widget -->
